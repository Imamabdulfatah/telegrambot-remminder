...
if __name__ == '__main__':
    ...
    scheduler.add_job(send_reminder, 'cron', hour=18, minute=1, args=[app.bot, REMINDER_CHAT_ID4, '<b>Cleanser: Hada Labo, Toner: Hada Labo Gold, Moisturizer: Hada Labo Milk</b>', None, True])
