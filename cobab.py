...
def handle_response(text: str) -> Tuple[str, Optional[str]]:
    text = text.lower()
    if 'hello' in text:
        return '<b>Hey there</b>', 'path/to/hello_photo.jpeg'  # Ganti dengan path ke foto yang ingin dikirim untuk "hello"
    
    if 'hey there' in text:
        return '<i>Hello there!</i>', 'path/to/hey_there_photo.jpeg'  # Ganti dengan path ke foto yang ingin dikirim untuk "Hey there"
    
    if 'i love python' in text:
        return '<u>Remember to subscribe</u>', None

    if 'mana foto' in text:
        return 'Ini fotonya:', 'path/to/photo.jpeg'  # Ganti dengan path ke foto yang ingin dikirim
...
if __name__ == '__main__':
    ...
    # Penjadwal foto
    photo_path = 'path/to/photo.jpeg'  # Ganti dengan path ke foto yang ingin dikirim
