...
if __name__ == '__main__':
    ...
    scheduler.add_job(send_reminder, 'cron', hour=15, minute=26, args=[app.bot, REMINDER_CHAT_ID3, '<b>Sampai jumpa!</b>', None, True])
    scheduler.add_job(send_reminder, 'cron', hour=17, minute=41, args=[app.bot, REMINDER_CHAT_ID4, '<b>Cleanser: Hada Labo, Toner: Hada Labo Gold, Moisturizer: Hada Labo Milk</b>', None, True])
    scheduler.add_job(send_reminder, 'cron', hour=7, minute=35, args=[app.bot, REMINDER_CHAT_ID4, '<b>Cleanser: Hada Labo, Toner: Hada Labo Gold, Moisturizer: Hada Labo Milk</b>', None, True])
